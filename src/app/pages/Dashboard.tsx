  ...
  return (
    <div className="w-full">
      ...
      <section className="py-20 md:py-32">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h1 className="text-4xl md:text-5xl mb-6">관리 대시보드</h1>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="glass-card glass-card-hover p-6">
              <div className="flex items-start justify-between mb-4">
                <div className="w-12 h-12 rounded-xl bg-[var(--accent-cyan-soft)] flex items-center justify-center">
                  <Thermometer className="text-[var(--accent-cyan)]" size={24} />
                </div>
                <span className="badge text-[var(--status-ok)]">정상</span>
              </div>
              
              <h3 className="text-xl mb-2">기기 상태</h3>
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <p className="text-xs text-[var(--text-muted)] mt-1">UL CLASS 125 경계선: 52°C</p>
                </div>
            ...
            <div className="glass-card glass-card-hover p-6">
              <div className="flex items-start justify-between mb-4">
                <div className="w-12 h-12 rounded-xl bg-[var(--accent-cyan-soft)] flex items-center justify-center">
                  <HardDrive className="text-[var(--accent-cyan)]" size={24} />
                </div>
                <span className="badge text-[var(--status-ok)]">RAID 1</span>
              </div>
              
              <h3 className="text-xl mb-2">저장소 용량</h3>
              <p className="text-sm text-[var(--text-secondary)] mb-4">
                SSD 용량 및 RAID 1 상태
              </p>
              ...
              <div className="space-y-3">
                ...
                <div className="p-3 rounded-lg bg-[var(--bg-primary)]/50 border border-[var(--border-hairline)]">
                  <div className="flex items-center gap-2 text-sm">
                    <Activity className="text-[var(--status-ok)]" size={16} />
            ...
            <div className="glass-card glass-card-hover p-6">
              <div className="flex items-start justify-between mb-4">
                <div className="w-12 h-12 rounded-xl bg-[var(--accent-cyan-soft)] flex items-center justify-center">
                  <Battery className="text-[var(--accent-cyan)]" size={24} />
                </div>
                <span className="badge text-[var(--status-ok)]">충전 중</span>
              </div>
              
              <h3 className="text-xl mb-2">UPS 상태</h3>
              <p className="text-sm text-[var(--text-secondary)] mb-4">
                배터리 잔량 및 전원 상태
              </p>
            ...
            {/* Access Log */}
            <div className="glass-card glass-card-hover p-6 md:col-span-2">
              <div className="flex items-start justify-between mb-4">
                <div className="w-12 h-12 rounded-xl bg-[var(--accent-cyan-soft)] flex items-center justify-center">
                  <Activity className="text-[var(--accent-cyan)]" size={24} />
                </div>
                <span className="badge text-[var(--text-secondary)]">최근 7일</span>
              </div>
              
              <h3 className="text-xl mb-2">접근 이력</h3>
              <p className="text-sm text-[var(--text-secondary)] mb-4">
                개폐 이력 및 데이터 접근 타임라인
              </p>
              ...
              <div className="space-y-3">
                {[
                  ...
                  <div key={index} className="flex items-start gap-3 p-3 rounded-lg hover:bg-[var(--bg-primary)]/50 transition-colors">
                    <div className={`w-2 h-2 rounded-full mt-2 flex-shrink-0 ${log.status === 'success' ? 'bg-[var(--status-ok)]' : 'bg-[var(--status-warn)]'}`}></div>
                    <div className="flex-1 min-w-0">
                      <div className="flex items-start justify-between gap-2 mb-1">
                        <span className="font-medium text-sm">{log.action}</span>
                        <span className="mono text-xs text-[var(--text-muted)] flex-shrink-0">{log.time}</span>
                      </div>
                      <p className="text-sm text-[var(--text-secondary)] truncate">{log.file}</p>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div className="glass-card glass-card-hover p-6">
              <div className="flex items-start justify-between mb-4">
                <div className="w-12 h-12 rounded-xl bg-[var(--accent-cyan-soft)] flex items-center justify-center">
                  <AlertTriangle className="text-[var(--accent-cyan)]" size={24} />
                </div>
                <span className="badge text-[var(--status-ok)]">0 건</span>
              </div>
              
              <h3 className="text-xl mb-2">보안 알림</h3>
              <p className="text-sm text-[var(--text-secondary)] mb-4">
                충격·파괴 시도 감지
              </p>
              
              <div className="p-4 rounded-lg bg-[var(--bg-primary)]/50 border border-[var(--border-hairline)] text-center">
                <FileCheck className="text-[var(--status-ok)] mx-auto mb-2" size={32} />
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl md:text-4xl text-center mb-12">Secure Port 제어</h2>
          
          <div className="glass-card p-8 max-w-3xl mx-auto">
            <div className="flex items-start gap-6 mb-6">
              <div className="w-16 h-16 rounded-xl bg-[var(--accent-cyan-soft)] flex items-center justify-center flex-shrink-0">
                <Lock className="text-[var(--accent-cyan)]" size={32} />
              </div>
              <div className="flex-1">
                <h3 className="text-2xl mb-2">USB-C 포트 상태</h3>
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between p-4 rounded-lg bg-[var(--bg-primary)]/50 border border-[var(--border-hairline)]">
                <div>
                  <h4 className="font-semibold mb-1">USB-C 포트</h4>
                  <p className="text-sm text-[var(--text-secondary)]">데이터 전송 및 충전</p>
                </div>
                <div className="flex items-center gap-3">
                  <span className="text-sm text-[var(--status-crit)]">비활성</span>
                  <div className="w-12 h-6 rounded-full bg-[var(--bg-elevated)] border border-[var(--border-hairline)] relative">
                    <div className="absolute left-1 top-1 w-4 h-4 rounded-full bg-[var(--text-muted)] transition-all"></div>
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-center justify-between p-4 rounded-lg bg-[var(--bg-primary)]/50 border border-[var(--border-hairline)]">
                <div>
                  <h4 className="font-semibold mb-1">네트워크 드라이브</h4>
                  <p className="text-sm text-[var(--text-secondary)]">Wi-Fi Direct 접근</p>
                </div>
                <div className="flex items-center gap-3">
                  <span className="text-sm text-[var(--status-crit)]">비활성</span>
                  <div className="w-12 h-6 rounded-full bg-[var(--bg-elevated)] border border-[var(--border-hairline)] relative">
              ...
              <div className="mt-6 p-4 rounded-lg bg-[var(--accent-cyan-soft)] border border-[var(--accent-cyan)]/20">
                <p className="text-sm text-[var(--text-secondary)]">
      ...
      <section className="py-20 bg-[var(--bg-elevated)]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl md:text-4xl text-center mb-12">캡처 기능</h2>
          
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            {/* OCR */}
            <div className="glass-card p-8">
              <div className="w-14 h-14 rounded-xl bg-[var(--accent-cyan-soft)] flex items-center justify-center mb-4">
                <FileCheck className="text-[var(--accent-cyan)]" size={28} />
              </div>
              
              <h3 className="text-2xl mb-3">문서 OCR</h3>
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-2">
                  ...
                  <span className="text-sm text-[var(--text-secondary)]">실시간 OCR 처리</span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="w-1.5 h-1.5 rounded-full bg-[var(--accent-cyan)] mt-2 flex-shrink-0"></div>
                  <span className="text-sm text-[var(--text-secondary)]">PDF 자동 변환</span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="w-1.5 h-1.5 rounded-full bg-[var(--accent-cyan)] mt-2 flex-shrink-0"></div>
                  <span className="text-sm text-[var(--text-secondary)]">원본은 단말에 남지 않음</span>
                </li>
              </ul>
            </div>
            ...
            <div className="glass-card p-8">
              ...
              <h3 className="text-2xl mb-3">음성 녹음</h3>
              <p className="text-[var(--text-secondary)] mb-6">
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-2">
                  <div className="w-1.5 h-1.5 rounded-full bg-[var(--accent-cyan)] mt-2 flex-shrink-0"></div>
                  <span className="text-sm text-[var(--text-secondary)]">화자 식별 기능</span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="w-1.5 h-1.5 rounded-full bg-[var(--accent-cyan)] mt-2 flex-shrink-0"></div>
                  <span className="text-sm text-[var(--text-secondary)]">STT 자동 변환</span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="w-1.5 h-1.5 rounded-full bg-[var(--accent-cyan)] mt-2 flex-shrink-0"></div>
                  <span className="text-sm text-[var(--text-secondary)]">타임스탬프 자동 기록</span>
                </li>
              </ul>
            </div>
          </div>
