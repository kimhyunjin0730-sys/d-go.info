...
export default function Support() {
  ...
  const copyEmail = () => {
    navigator.clipboard.writeText("sales@d-go.info");
    setCopied(true);
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
                  {[
                    ...
                    <a
                      key={type}
                      href={`mailto:sales@d-go.info?subject=문의: ${type}`}
              ...
              <div className="p-3 rounded-lg bg-[var(--bg-primary)]/50 border border-[var(--border-hairline)]">
                <p className="text-xs text-[var(--text-secondary)]">
                  <span className="text-[var(--accent-cyan)] font-semibold">안내:</span> 메일 앱이 열리지 않으면 <span className="mono text-[var(--accent-cyan)]">sales@d-go.info</span> 으로 직접 보내주세요.
                </p>
              </div>
            </div>
          </div>
