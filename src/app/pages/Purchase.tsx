  ...
  return (
    <div className="w-full">
      ...
      <section className="pt-10 pb-6">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-6">
            ...
            <h1 className="text-2xl md:text-3xl mb-3">구매 안내</h1>
            <p className="text-lg text-[var(--text-secondary)] max-w-3xl mx-auto">
              법인·단체 도입 문의 환영합니다 — 전문 상담을 통해 최적의 솔루션을 제공합니다
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-10 md:py-14 bg-gradient-to-br from-cyan-500/10 to-blue-600/10">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="glass-card p-5 md:p-8">
            <div className="text-center mb-6">
              <h2 className="text-2xl md:text-3xl mb-2">법인·단체 도입 문의</h2>
            ...
            <div className="grid md:grid-cols-2 gap-4 mb-6">
              ...
              >
                <div className="w-12 h-12 rounded-xl bg-[var(--accent-cyan-soft)] flex items-center justify-center mx-auto mb-3 group-hover:bg-[var(--accent-cyan)] transition-colors">
                  <Mail className="text-[var(--accent-cyan)] group-hover:text-[var(--bg-primary)] transition-colors" size={24} />
                </div>
              ...
              >
                <div className="w-12 h-12 rounded-xl bg-[var(--accent-cyan-soft)] flex items-center justify-center mx-auto mb-3 group-hover:bg-[var(--accent-cyan)] transition-colors">
                  <Phone className="text-[var(--accent-cyan)] group-hover:text-[var(--bg-primary)] transition-colors" size={24} />
                </div>
                <h3 className="text-lg font-semibold mb-1">전화 상담</h3>
                <p className="text-sm text-[var(--text-secondary)] mb-1">
                  010-3241-0427
                </p>
                <p className="text-xs text-[var(--text-muted)]">
            ...
            <div className="flex items-start gap-3 p-3 rounded-lg bg-[var(--bg-primary)]/50 border border-[var(--border-hairline)]">
              <Clock className="text-[var(--accent-cyan)] flex-shrink-0 mt-0.5" size={18} />
              <div>
                <h4 className="font-semibold text-sm mb-0.5">평균 응답 시간</h4>
                <p className="text-xs text-[var(--text-secondary)]">
                  이메일: 24시간 이내 · 전화: 즉시 상담 (운영시간 내)
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-10 md:py-14">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl md:text-3xl text-center mb-6">구매 유형</h2>
          ...
          <div className="grid md:grid-cols-2 gap-4 max-w-5xl mx-auto">
            ...
            <div className="glass-card glass-card-hover p-5 relative overflow-hidden group">
              ...
              <div className="relative">
                <div className="w-12 h-12 rounded-xl bg-[var(--accent-cyan-soft)] flex items-center justify-center mb-3">
                  <Building2 className="text-[var(--accent-cyan)]" size={24} />
                </div>

                <h3 className="text-xl mb-2">법인 도입</h3>
                ...
                <a
                  href="mailto:sales@d-go.info?subject=법인 도입 문의"
            ...
            <div className="glass-card glass-card-hover p-5 relative overflow-hidden group">
              ...
              <div className="relative">
                ...
                <h3 className="text-xl mb-2">개인·소규모 구매</h3>
                <p className="text-sm text-[var(--text-secondary)] mb-4 leading-relaxed">
                ...
                <a
                  href="mailto:sales@d-go.info?subject=개인 구매 문의"
                  className="inline-flex items-center gap-2 text-[var(--accent-cyan)] font-semibold hover:gap-3 transition-all text-sm"
                >
                  구매 문의하기 →
                </a>
      ...
      <section className="py-10 md:py-14 bg-[var(--bg-elevated)]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-6">
            <h2 className="text-2xl md:text-3xl mb-2">견적 요청</h2>
            <p className="text-base text-[var(--text-secondary)]">
              아래 정보를 포함하여 문의해주시면 신속하게 견적을 안내해드리겠습니다
            </p>
          </div>
          ...
          <div className="glass-card p-5">
            <div className="space-y-4">
              <div>
                <h3 className="font-semibold text-sm mb-2 text-[var(--accent-cyan)]">필수 정보</h3>
              ...
              <div>
                <h3 className="font-semibold text-sm mb-2 text-[var(--accent-cyan)]">선택 정보</h3>
                <ul className="space-y-1.5">
                  <li className="flex items-start gap-2 text-sm text-[var(--text-secondary)]">
                    <div className="w-1.5 h-1.5 rounded-full bg-[var(--accent-cyan)] mt-1.5 flex-shrink-0"></div>
                    <span>희망 도입 시기</span>
              ...
              <div className="pt-4 border-t border-[var(--border-hairline)]">
                <a
                  href="mailto:sales@d-go.info?subject=D-GO Quantum Data Vault 견적 요청&body=회사명: %0D%0A담당자: %0D%0A연락처: %0D%0A희망 수량: %0D%0A사용 용도: %0D%0A%0D%0A기타 문의사항: "
      ...
      <section className="py-10 md:py-14">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-6">
            <h2 className="text-2xl md:text-3xl mb-2">판매 파트너</h2>
            <p className="text-base text-[var(--text-secondary)]">
          ...
          <div className="glass-card p-8 max-w-3xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[var(--bg-primary)] border border-[var(--border-hairline)] mb-3">
              <span className="badge text-[var(--text-secondary)]">준비 중</span>
            </div>
            <p className="text-sm text-[var(--text-secondary)]">
              공식 판매 파트너 네트워크를 구축 중입니다. 현재는 직접 문의를 통한 구매만 가능합니다.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-10 md:py-14 bg-gradient-to-br from-cyan-500/10 to-blue-600/10">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-2xl md:text-3xl mb-4">구매 상담 안내</h2>

          <div className="glass-card p-5 mb-6">
            <div className="grid md:grid-cols-2 gap-4 text-left">
              <div>
                <h3 className="font-semibold text-sm mb-1.5 text-[var(--accent-cyan)]">운영 시간</h3>
                <p className="text-sm text-[var(--text-secondary)]">
                  평일: 09:00 - 18:00<br />
                  주말 및 공휴일: 휴무<br />
                  이메일: 24시간 접수 가능
          ...
          <p className="text-base text-[var(--text-secondary)]">
            궁금한 점이 있으시다면 언제든 문의해주세요. 전문 상담원이 친절하게 안내해드리겠습니다.
          </p>
        </div>
      </section>
    </div>
